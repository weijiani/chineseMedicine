  ...
  <div class="patient-detail-wrap">
    ...
    >
      ...
      <el-form-item prop="birthData" label="出生日期">
        <el-date-picker v-model="ruleForm.birthData" type="date" placeholder="选择日期"></el-date-picker>
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        telNumber: [{ required: true, message: "手机号不能为空" }],
        region: [{ required: true, message: "地址不能为空" }]
      },
      newSubmit: true
    };
  },
