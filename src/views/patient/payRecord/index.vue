<template>
  <div class="pay-record-wrap">
    ...
    <el-table :data="payRecordList" border style="width: 70%">
      <el-table-column prop="createTime" label="支付日期" width="180"></el-table-column>
      <el-table-column prop="pay" label="支付费用(元)" width="180"></el-table-column>
      <el-table-column prop="payWay" label="支付方式"></el-table-column>
      <el-table-column prop="payDes" label="支付描述"></el-table-column>
    </el-table>
  </div>
</template>
